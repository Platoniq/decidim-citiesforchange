...
Decidim.configure do |config|
  ...
  config.application_name = "Cities For Change Decidim"

  # The email that will be used as sender in all emails from Decidim
  config.mailer_sender = "noreply@citiesforchange.org"
  ...
  Decidim.content_blocks.register(:homepage, :latest_blog_posts) do |content_block|
    ...
    content_block.settings_form_cell = "decidim/content_blocks/latest_blog_posts_form"
  ...
  Decidim.content_blocks.register(:homepage, :upcoming_meetings) do |content_block|
    ...
    content_block.settings_form_cell = "decidim/content_blocks/upcoming_meetings_form"
